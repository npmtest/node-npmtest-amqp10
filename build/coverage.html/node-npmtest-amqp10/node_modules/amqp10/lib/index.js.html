...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-amqp10/node_modules/amqp10/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-amqp10/node_modules/amqp10/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-amqp10/node_modules/amqp10/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
&nbsp;
  ...
  Policy: {
    ...
    Utils: pu,
    merge: <span class="fstat-no" title="function not covered" >function(overrides, base) {</span> <span class="cstat-no" title="statement not covered" >return pu.Merge(overrides, base || new Policy()); </span>}
  },
&nbsp;
...
&nbsp;
   ...
   */
  use: <span class="fstat-no" title="function not covered" >function(plugin) {</span>
<span class="cstat-no" title="statement not covered" >    if (typeof plugin !== 'function') {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Plugin is not a function');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    plugin(Client);</span>
  }
};
&nbsp;
&nbsp;</pre></td></tr>
